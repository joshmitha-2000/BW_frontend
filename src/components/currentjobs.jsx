...
import { ArrowRight } from "lucide-react"; // Optional: Install lucide-react or use a regular symbol
  ...
  return (
    <section className="bg-white w-full py-16 px-4">
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        {/* Extra call-to-action box */}
        <div className="bg-gray-100 mt-12 p-6 rounded-lg shadow-md flex items-center justify-between">
          <div>
          ...
          <button
            ...
            className="bg-gradient-to-r from-[#c504d6] via-[#880294] to-[#510059] 
                       text-white px-4 py-2 rounded-full shadow-lg hover:scale-105 transition duration-300"
          >
            <ArrowRight size={20} />
            {/* If you don't want to use lucide-react, replace with: ➔ */}
          </button>
        </div>
      </div>
    </section>
